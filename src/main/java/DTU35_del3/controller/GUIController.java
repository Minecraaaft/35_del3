...
public class GUIController {
    ...
    private GUI_Field[] fields = {
            ...
            new GUI_Brewery("src/main/resources/Pictures/På_besøg.jpg", "På Besøg", "", "", "", Color.WHITE, Color.BLACK),
            ...
            new GUI_Brewery("src/main/resources/Pictures/Chance.jpg", "Chance", "", "", "", new Color(235, 156, 48), Color.BLACK),
            new GUI_Brewery("src/main/resources/Pictures/Legetøj.jpg", "Legetøjsbutiken", "3M", "", "3", Color.YELLOW, Color.BLACK),
            new GUI_Brewery("src/main/resources/Pictures/Dyrehandel.jpg", "Dyrehandlen", "3M", "", "3", Color.YELLOW, Color.BLACK),
            new GUI_Brewery("src/main/resources/Pictures/Gå_i_fængsel.jpg", "Gå i", "fængsel", "", "", Color.WHITE, Color.BLACK),
